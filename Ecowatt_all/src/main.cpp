...
// ---- CONFIG ----
const char* WIFI_SSID = "Dialog 4G 151";
const char* WIFI_PASS = "662F9d5D";
const String INVERTER_API_KEY =
  "NjhhZWIwNDU1ZDdmMzg3MzNiMTQ5YTIyOjY4YWViMDQ1NWQ3ZjM4NzMzYjE0OWExOA==";
const String CLOUD_BASE_URL = "http://192.168.8.185:5000"; // set to your PC IP running cloud.py

SampleBuffer gBuf(1024);
EcoWattUploader gUp(CLOUD_BASE_URL, INVERTER_API_KEY, 15000, 600, 3);
